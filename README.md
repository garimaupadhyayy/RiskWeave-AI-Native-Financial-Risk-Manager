...
* **Financial Cost Optimizer:** Automatically calculates the mathematical Expected Loss for all possible actions. For example, it automatically chooses STEP_UP (MFA) over HOLD for medium-risk, high-value transactions to preserve conversion rates, because the .75 insult cost of a false positive outweighs a .00 manual review fee.
